...
const Add = ({ token }) => {
  ...
  const [category, setCategory] = useState("NATIONAL TEAMS");
  const [subCategory, setSubCategory] = useState("Argentina");
      ...
      <div className=' flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          ...
          >
            ...
            <option value='PRIMER LEAGUE'>Primer league</option>
        ...
        <div>
          ...
          >
            ...
            <option value='Borussia Dourtmund'>Borussia Dourtmund</option>
        ...
        <div>
          ...
          <input
            ...
            value={price}
            className=' w-full px-3 py-2 sm:2-[120px]'
            type='Number'
            placeholder='25'
          />
        </div>
